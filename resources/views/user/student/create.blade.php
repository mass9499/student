                        ...
                        <div class="m-portlet__body">
                            <div class="m-form__section m-form__section--first">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                            <input type="text" id="dob" name="dob" class="form-control" required="" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                          <input type="text" class="form-control" id="application_date" name="application_date"   required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                          <input type="text" class="form-control" name="action_needed"  required>
                                    </div>
                                </div>
                                ...
                                <div class="row_container"> 
                                 <div class="form-group m-form__group row" id="org_row">
                                    ...
                                    <button type="button" class="btn btn-primary" id="add_row"><i class="fa fa-plus"> </i></button>&nbsp;
                                    <button type="button" class="btn btn-danger" id="remove_row" ><i class="fa fa-minus"> </i></button>

                                  </div>  
                                </div>

                                <div id="cloned_row">  </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#add_row").click(function(){
            $(".row_container #org_row").clone().appendTo("#cloned_row");

            $("#cloned_row #org_row").find("button").css('display', 'none');
        });
    
        $("#remove_row").click(function(){
            $("#cloned_row #org_row").last().remove();
       });

...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    ...
    <form method="post" action="{{ url('admin/invoice/store') }}/{{$student->id}}" enctype="multipart/form-data"> 
        @csrf
            <div class="row">
                <div class="col-md-6">
                    <!-- <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" required class="form-control" name="invoice_number" placeholder="" value="{{ old('invoice') }}">
                        </div>   
                    </div> -->
                ...
                <div class="col-md-6">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control date_picker" name="billing_date" id="date" value="{{ old('date',date('Y-m-d')) }}"  >
                        </div>   
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        <tr class="tr_clone all_app">
                            <td>
                             ...
                             <td>
                                <input type="text" class="form-control" id="application_name" name="application_name[]" style="margin-top:20px;height:35px;" required>
                            </td>
                           
                            <td>
                                <input type="number" class="form-control application_fees" id="application_fees" name="application_fees[]" style="margin-top:20px;height:35px;" required>
                            </td>
                         
                            <td>
                               <input type="number" class="form-control service_fees" id="service_fees" name="service_fees[]" style="margin-top:20px;height:35px;" required>
                            </td>

                            <td>
                                <input type="text" class="form-control amount" id="amount" name="amount[]" autocomplete="off" style="width:250px;margin-top:20px;height:35px;">
                            </td>
...
//     $("#service_fees").keyup(function(){
//      var app_fees = $("#application_fees").val();
//      var ser_fees = $("#service_fees").val();

//         //total_amount =  app_fees + ser_fees;
